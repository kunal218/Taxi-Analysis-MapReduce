...
public class LeastWeatherSales extends Configured implements Tool{
	public static void main(String[] args) throws Exception {

		int exitCode = ToolRunner.run(new LeastWeatherSales(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(LeastWeatherSales.class);
		...
		job2.setJarByClass(LeastWeatherSales.class);
