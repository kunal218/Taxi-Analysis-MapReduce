...
public class YearlyAwards extends Configured implements Tool{
	public static void main(String[] args) throws Exception {

		int exitCode = ToolRunner.run(new YearlyAwards(), args);
	...
	public int run(String[] args) throws Exception {
		...
		job2.setJarByClass(YearlyAwards.class);
		job2.setMapperClass(KeySeperatorMapper.class);
